...
15. Kubernetes base manifests use `k8s/base/secrets.yaml` for local/dev credential injection; production environments should replace these values via external secret management.
